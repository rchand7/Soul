                        ...
                        <div className="contact-info flex justify-center items-center bg-blue-50 p-6 rounded-lg shadow-md">
                            <div>
                                ...
                                <Paragraph>
                                    ...
                                    <span className="font-bold">Address:</span> Greater Noida, U.P
                                </Paragraph>
                                <Paragraph>
                                ...
                                <Paragraph>
                                    ...
                                    <span className="font-bold">Email:</span> <a href="mailto:thakurarjun5956@gmail.com" className="text-blue-700">thakurarjun5956@gmail.com</a>
                                </Paragraph>
                            </div>
                        </div>
